...
public class ShoppingPrint {
	...
	public static void main(String[] args) throws Exception {
		String[] items = new String[] { "ITEM000001", "ITEM000001",
	 ...
	 * @return void
	 */
	public static void printInventor(String[] items){
		Map<String,Map<String,String>>  resultMap = getItemsResult(items);
